...
,
    {       'alt': 'Klassisk lyxig räkmacka med handskalade räkor, kokt ägg, majonnäs, dill och citron på surdegsbröd',
        ...
        'cat_slug': 'hogtider-och-smorgasbord',
        'category': 'Högtider & Smörgåsbord',
        'community_reviews': [       {       'comment': 'Så här ska en äkta svensk räkmacka smaka! Att smörsteka '
                                                        'levainbrödet och handskala räkorna gör hela skillnaden.',
                                             'date': 'Idag',
        ...
        'faqs': [       {       'a': 'Räkna med cirka 200 gram oskalade räkor per macka, vilket ger cirka 70-80 gram '
                                     'ren räkkött – perfekt för ett lyxigt räkberg.',
                                'q': 'Hur många räkor per person behöver man till en rejäl räkmacka?'},
                        {       'a': 'Ett lätt rostat ljust surdegsbröd eller en klassisk tekaka/formfranska smörstekt '
                                     'i panna ger den perfekta krispiga kontrasten mot de mjuka räkorna.',
        ...
        'ingredients': [       {       'group': 'Räkmacka',
                                       'items': [       {       'name': 'färska räkor med skal (ger ca 300g skalade)',
                                                                'unit': 'g',
                                                                'val': 800},
                                                        {       'name': 'ljust surdegsbröd eller formfranska',
                                                                'unit': 'skivor',
                                                                'val': 4},
                                                        {       'name': 'ekologiska ägg (hårdkokta eller mjukstelnade)',
                                                                'unit': 'st',
                                                                'val': 4},
                                                        {       'name': 'krispig krispsallad eller romansallad',
                                                                'unit': 'blad',
                                                                'val': 4},
                                                        {       'name': 'äkta majonnäs av god kvalitet',
                                                                'unit': 'dl',
                                                                'val': 1.5},
                                                        {'name': 'stenbittsrom eller löjrom', 'unit': 'tsk', 'val': 4},
                                                        {'name': 'färsk dill', 'unit': 'kruka', 'val': 1},
                                                        {'name': 'citron (i klyftor)', 'unit': 'st', 'val': 1},
                                                        {       'name': 'smör (att smörsteka brödet i)',
                                                                'unit': 'msk',
                                                                'val': 2},
                                                        {       'name': 'flingsalt och nymalen svartpeppar',
                                                                'unit': 'nypa',
                                                                'val': 1}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Skala alla räkor och lägg dem i en skål i kylen. Koka äggen i cirka '
                                                '7–8 minuter så gulan är krämig men fast. Spola i iskallt vatten, '
                                                'skala och skiva i skivor eller klyftor.',
                                        'timer': 8,
                                        'title': 'Skala räkorna & koka äggen'},
                                {       'step': 2,
                                        'text': 'Hetta upp smör i en stekpanna och stek brödskivorna gyllene och '
                                                'frasiga på båda sidor, eller rosta i brödrost och bre med ett tunt '
                                                'lager smör. Låt svalna något.',
                                        'timer': 3,
                                        'title': 'Rosta brödet'},
                                {       'step': 3,
                                        'text': 'Lägg ett krispigt salladsblad på varje brödskiva. Klicka på en '
                                                'matsked majonnäs och fördela de skivade äggen ovanpå.',
                                        'timer': None,
                                        'title': 'Bottna smörgåsen'},
                                {       'step': 4,
                                        'text': 'Lägg upp en generös mängd handskalade räkor som en hög kulle på varje '
                                                'macka. Klicka en extra sked majonnäs på toppen.',
                                        'timer': None,
                                        'title': 'Bygg räkberget'},
                                {       'step': 5,
                                        'text': 'Toppa med en klick rom, en riklig vippa färsk dill, en citronklyfta '
                                                'och ett drag nymalen svartpeppar. Servera direkt!',
                                        'timer': None,
    ...
    {       'alt': 'Krämig klassisk fläskfilégryta med champinjoner, dijonsenap och persilja i rustik gryta',
        ...
        'cat_slug': 'husmanskost',
        'category': 'Husmanskost',
        'community_reviews': [       {       'comment': 'En riktig klassiker som alltid gör succé på lördagskvällen. '
                                                        'Såsen med dijonsenap och syltlök är magisk!',
                                             'date': 'Idag',
                                             'name': 'Fredrik Eklund',
                                             'rating': 5,
                                             'verified': True},
        ...
        'faqs': [       {       'a': 'Ja, kycklingfilé eller kycklinglårfilé i bitar fungerar alldeles utmärkt och '
                                     'passar perfekt i denna dijonsås.',
                                'q': 'Kan man byta ut fläskfilén mot kyckling?'},
                        {       'a': 'Ja, grytan går bra att frysa, men såser med crème fraiche och grädde kan skära '
                                     'sig lätt vid upptining. Värm försiktigt under omrörning.',
                                'q': 'Går grytan att frysa?'}],
        'file': 'klassisk-flaskfilegryta-champinjoner-dijon.html',
        'img': 'flaskfilegryta',
        'ingredients': [       {       'group': 'Fläskfilégryta',
                                       'items': [       {       'name': 'fläskfilé eller fläskytterfilé (putsad & '
                                                        ...
                                                        {       'name': 'färsk bladpersilja (finhackad)',
                                                                'unit': 'kruka',
                                                                'val': 1},
                                                        {'name': 'torkad timjan', 'unit': 'tsk', 'val': 1},
                                                        {'name': 'svartpeppar & salt', 'unit': 'krm', 'val': 1}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Skär den putsade fläskfilén i cirka 2 cm tjocka medaljonger. Salta '
                                                'och peppra. Hetta upp 1 msk smör i en panna och bryn köttet snabbt på '
                                                'hög värme ca 1–2 minuter per sida så det får fin stekyta. Lyft upp '
                                                'köttet på ett fat (det ska inte genomstekas helt nu).',
                                        'timer': 4,
                                        'title': 'Bryn fläskfilén'},
                                {       'step': 2,
                                        'text': 'I samma panna, tillsätt resten av smöret. Fräs champinjonerna på '
                                                'medelhög värme tills vätskan avdunstat och svampen fått fin färg. '
                                                'Tillsätt lök, vitlök och timjan och fräs ytterligare 3 minuter tills '
                                                'löken är mjuk.',
                                        'timer': 6,
                                        'title': 'Stek svamp och lök'},
                                {       'step': 3,
                                        'text': 'Häll i grädde, crème fraiche, kalvfond, dijonsenap och soja. Rör om '
                                                'och låt såsen sjuda försiktigt på medelvärme i cirka 5–7 minuter så '
                                                'den tjocknar och blir fyllig.',
                                        'timer': 7,
                                        'title': 'Koka ihop såsen'},
                                {       'step': 4,
                                        'text': 'Lägg tillbaka köttet tillsammans med köttsaften och syltlöken i '
                                                'grytan. Låt sjuda sakta i 4–5 minuter tills fläskfilén är saftig och '
                                                'precis genomstekt (ca 68-70°C innertemperatur).',
                                        'timer': 5,
                                        'title': 'Sjud köttet mört'},
                                {       'step': 5,
                                        'text': 'Smaka av med salt, peppar och eventuellt en skvätt mer dijonsenap. '
                                                'Strö över rikligt med färskhackad persilja och servera med kokt ris '
                                                'eller potatis.',
                                        'timer': None,
                                        'title': 'Garnera och servera'}],
    ...
    {       'alt': 'Klassisk knäckig rabarberpaj med havresmultäcke serverad med len vaniljsås',
        ...
        'cat_slug': 'fika-och-bakning',
        'category': 'Fika & Bakning',
        'community_reviews': [       {       'comment': 'Bästa rabarberpajen jag ätit! Kardemumman i fyllningen lyfter '
                                                        'smaken till en helt ny nivå.',
                                             'date': 'Idag',
                                             'name': 'Kerstin Berg',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Perfekt balans mellan syrlig rabarber och knäckigt '
                                                        'havretäcke. Klart godkänd av hela familjen.',
                                             'date': 'I förrgår',
        ...
        'faqs': [       {       'a': 'Nej, späda och fina stjälkar behöver inte skalas – skalet ger dessutom den '
                                     'underbara rosa färgen. Skala bara om rabarbern är grov och träig.',
                                'q': 'Måste man skala rabarbern?'},
                        {       'a': 'Ja, det går alldeles utmärkt! Tina rabarbern och häll av den värsta vätskan, öka '
                                     'sedan potatismjölet med en halv matsked.',
                                'q': 'Kan man baka med fryst rabarber?'}],
        'file': 'klassisk-rabarberpaj-knackig-smuldeg.html',
        'img': 'rabarberpaj',
        'ingredients': [       {       'group': 'Rabarberfyllning',
                                       'items': [       {       'name': 'färsk rabarber (skuren i 1-2 cm bitar)',
                                                                'unit': 'g',
                                                                'val': 500},
                                                        ...
                                                        {       'name': 'potatismjöl (binder överflödig vätska)',
                                                                'unit': 'msk',
                                                                'val': 1.5},
                                                        {       'name': 'malen kardemumma (färskmortlad)',
                                                                'unit': 'tsk',
                                                                'val': 1}]},
        ...
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 200°C (över- och undervärme). Skölj och ansa rabarbern '
                                                'och skär den i cirka 1–2 cm tjocka bitar. Lägg i en smord pajform.',
                                        'timer': None,
                                        'title': 'Förbered ugn och rabarber'},
                                {       'step': 2,
                                        'text': 'Strö över socker, potatismjöl och nymortlad kardemumma över rabarbern '
                                                'direkt i formen. Blanda om försiktigt så alla bitar täcks jämnt.',
                                        'timer': None,
                                        'title': 'Blanda fyllningen'},
                                {       'step': 3,
                                        'text': 'Blanda vetemjöl, havregryn, strösocker, vaniljsocker och flingsalt i '
                                                'en bunke. Tillsätt det kalla, tärnade smöret och nyp snabbt ihop med '
                                                'fingrarna till en grov, smulig deg.',
                                        'timer': None,
                                        'title': 'Nyp ihop smuldegen'},
                                {       'step': 4,
                                        'text': 'Fördela smuldegen jämnt över rabarbern. Grädda mitt i ugnen i cirka '
                                                '20–25 minuter tills pajen har fått fin gyllene färg och rabarbern '
                                                'bubblar runt kanterna.',
                                        'timer': 22,
                                        'title': 'Täck och grädda'},
                                {       'step': 5,
                                        'text': 'Låt pajen sätta sig i cirka 10 minuter efter gräddning så smultäcket '
                                                'blir härligt krispigt. Servera ljummen med massor av kall hemlagad '
    ...
    {       'alt': 'Klassiska spröda vaniljdrömmar med krackelerad yta på kakfat bredvid en kaffekopp',
        ...
        'cat_slug': 'fika-och-bakning',
        'category': 'Fika & Bakning',
        'community_reviews': [       {       'comment': 'Precis som mormor bakade dem! Smälter i munnen och spricker '
                                                        'upp så fint.',
                                             'date': 'Idag',
                                             'name': 'Birgitta Nilsson',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Underbart spröda kakor till kaffet. Perfekt recept med exakta '
                                                        'mått.',
                                             'date': 'Igår',
                                             'name': 'Magnus K.',
                                             'rating': 5,
        ...
        'faqs': [       {       'a': 'Det är hjorthornssaltet som avger ammoniumgas under gräddningen. Lukten '
                                     'försvinner helt när kakorna svalnat och är hemligheten bakom den porösa '
                                     'sprödheten.',
                                'q': 'Varför luktar det ammoniak när man gräddar drömmar?'},
                        {       'a': 'Nej, bakpulver ger en helt annan, mjukare konsistens. För äkta drömmar som '
                                     'smälter i munnen är hjorthornssalt oumbärligt.',
        ...
        'ingredients': [       {       'group': 'Drömmar (ca 30 st)',
                                       'items': [       {'name': 'rumsvarmt äkta smör', 'unit': 'g', 'val': 100},
                                                        ...
                                                        {       'name': 'äkta vaniljsocker (eller vaniljpulver)',
                                                                'unit': 'msk',
                                                                'val': 1},
                                                        {'name': 'hjorthornssalt', 'unit': 'tsk', 'val': 1},
                                                        {'name': 'vetemjöl', 'unit': 'dl', 'val': 4}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 150°C (över- och undervärme). Vispa det rumstempererade '
                                                'smöret och sockret vitt och pösigt med elvisp i cirka 3–4 minuter.',
                                        'timer': 4,
                                        'title': 'Vispa smör och socker'},
                                {       'step': 2,
                                        'text': 'Häll i rapsoljan lite i taget under konstant vispning tills smeten är '
                                                'helt jämn och krämig.',
                                        'timer': None,
                                        'title': 'Tillsätt oljan droppvis'},
                                {       'step': 3,
                                        'text': 'Blanda vetemjöl, vaniljsocker och hjorthornssalt i en separat skål. '
                                                'Sikta ner i smeten och arbeta snabbt ihop till en smidig deg med '
                                                'händerna.',
                                        'timer': None,
                                        'title': 'Blanda torra ingredienser'},
                                {       'step': 4,
                                        'text': 'Dela degen i cirka 30 jämna delar. Rulla till runda bollar och lägg '
                                                'på plåtar klädda med bakplåtspapper. Lämna lite mellanrum då kakorna '
                                                'flyter ut något.',
                                        'timer': None,
                                        'title': 'Rulla bollar'},
                                {       'step': 5,
                                        'text': 'Grädda mitt i ugnen i cirka 18–20 minuter. Kakorna ska spricka upp '
                                                'vackert men förbli ljust elfenbensvita. Låt svalna helt på plåten så '
                                                'de stelnar och blir superspröda.',
                                        'timer': 18,
    ...
    {       'alt': 'Klassisk laxpudding med potatis och dill serverad med skirat gyllene smör och citronklyfta',
        ...
        'cat_slug': 'husmanskost',
        'category': 'Husmanskost',
        'community_reviews': [       {       'comment': 'Klassisk svensk husmanskost när den är som allra bäst. '
                                                        'Äggstanningen blev perfekt krämig och dillen gav underbar '
                                                        'arom.',
                                             'date': 'Idag',
                                             'name': 'Lars-Olov S.',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Enastående recept! Skirat smör och citron till är ett absolut '
                                                        'måste.',
                                             'date': 'I förrgår',
                                             'name': 'Gunilla H.',
                                             'rating': 5,
        ...
        'faqs': [       {       'a': 'Klassisk rimmad eller gravad lax ger den bästa autentiska smaken och sältan. Har '
                                     'du färsk laxfilé kan du grava eller rimma den snabbt i 2 timmar före tillagning.',
                                'q': 'Vilken sorts lax är bäst till laxpudding?'},
                        {       'a': 'Ja, den är perfekt att förbereda och grädda strax innan gästerna kommer, eller '
                                     'värma upp dagen efter då smakerna satt sig ännu mer.',
                                'q': 'Kan man förbereda laxpuddingen i förväg?'}],
        'file': 'klassisk-laxpudding-potatis-skirat-smor.html',
        'img': 'laxpudding',
        'ingredients': [       {       'group': 'Laxpudding',
                                       'items': [       {       'name': 'rimmad, gravad eller kallrökt lax (i tunna '
                                                                        'skivor eller strimlor)',
                                                                'unit': 'g',
                                                                'val': 400},
                               ...
                               {       'group': 'Tillbehör & Servering',
                                       'items': [       {'name': 'smör (smält / skirat)', 'unit': 'g', 'val': 75},
                                                        {'name': 'citron (i klyftor)', 'unit': 'st', 'val': 1},
                                                        {       'name': 'gröna ärtor (valfritt tillbehör)',
                                                                'unit': 'dl',
                                                                'val': 1}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 200°C (över- och undervärme). Smörj en ugnsfast form. '
                                                'Skiva löken tunt och fräs den mjuk och glansig i 1 msk smör utan att '
                                                'den tar färg.',
                                        'timer': 5,
                                        'title': 'Förbered ugn och lök'},
                                {       'step': 2,
                                        'text': 'Börja med ett lager skivad kokt potatis i botten av formen. Lägg på '
                                                'hälften av den stekta löken, hälften av laxen och rikligt med hackad '
                                                'dill. Upprepa och avsluta med ett lager potatisskivor på toppen.',
                                        'timer': None,
                                        'title': 'Varva potatis, lax och dill'},
                                {       'step': 3,
                                        'text': 'Vispa ihop ägg, mjölk, grädde, vitpeppar och lite salt i en bunke. '
                                                'Häll äggstanningen jämnt över puddingen så den rinner ner mellan '
                                                'lagren.',
                                        'timer': None,
                                        'title': 'Vispa ihop äggstanningen'},
                                {       'step': 4,
                                        'text': 'Grädda mitt i ugnen i cirka 35–40 minuter tills äggstanningen har '
                                                'stannat helt och puddingens yta har fått en vacker gyllenbrun färg.',
                                        'timer': 40,
                                        'title': 'Grädda i ugnen'},
                                {       'step': 5,
                                        'text': 'Smält smöret i en liten kastrull på låg värme. Låt puddingen vila i '
                                                '5–10 minuter före servering. Servera i rejäla bitar, ringla rikligt '
                                                'med skirat smör över och servera med citron.',
                                        'timer': 5,
    ...
    {       'alt': 'Klassiska kladdkakemuffins med frasig yta och rinnig chokladkärna toppade med florsocker och hallon',
        ...
        'cat_slug': 'fika-och-bakning',
        'category': 'Fika & Bakning',
        'community_reviews': [       {       'comment': 'Helt fantastiska! Exakt 11 minuter i ugnen gav den där '
                                                        'drömmiga rinnande chokladmitten.',
                                             'date': 'Idag',
                                             'name': 'Sofia Lind',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Bästa kladdkakereceptet i portionsformat. Barnen slukade dem '
                                                        'på fem minuter!',
                                             'date': 'Igår',
                                             'name': 'Anders Kvist',
                                             'rating': 5,
        ...
        'faqs': [       {       'a': 'De håller sig saftiga och goda i 4-5 dagar i en lufttät burk i kylen. De går '
                                     'också utmärkt att frysa in.',
                                'q': 'Hur länge håller kladdkakemuffins?'},
                        {       'a': 'Pappersformar viker sig lätt under smetens tyngd. En stabil muffinsplåt tvingar '
                                     'smeten uppåt och ger höga, perfekta muffins med intakt kladdig kärna.',
        ...
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 200°C (över- och undervärme). Placera 12 muffinsformar '
                                                'i en muffinsplåt – plåten hjälper muffinsen att hålla formen och inte '
                                                'flyta ut.',
                                        'timer': None,
                                        'title': 'Förbered ugn och plåt'},
                                {       'step': 2,
                                        'text': 'Smält smöret i en kastrull och ta från värmen. Rör ner ägg och socker '
                                                'direkt i kastrullen med en slev. Vispa inte för mycket luft i smeten.',
                                        'timer': None,
                                        'title': 'Smält smör och rör ihop'},
                                {       'step': 3,
                                        'text': 'Sikta ner vetemjöl, kakao, vaniljsocker och flingsalt. Rör försiktigt '
                                                'till en slät, glansig chokladsmet.',
                                        'timer': None,
                                        'title': 'Tillsätt torra ingredienser'},
                                {       'step': 4,
                                        'text': 'Fördela smeten jämnt i muffinsformarna (fyll till cirka 3/4). Grädda '
                                                'mitt i ugnen i exakt 10–12 minuter. Kanterna ska stelna men mitten '
                                                'ska dallra mjukt.',
                                        'timer': 11,
                                        'title': 'Fördela och grädda'},
                                {       'step': 5,
                                        'text': 'Låt svalna en stund så de sätter sig något. Pudra över florsocker och '
                                                'toppa med färska hallon och en klick lättvispad grädde.',
                                        'timer': 10,
    ...
    {       'alt': 'Klassisk krämig köttfärsgratäng med skivad potatis och bubblande gratinerad ost i form',
        ...
        'cat_slug': 'husmanskost',
        'category': 'Husmanskost',
        'community_reviews': [       {       'comment': 'Underbar vardagsrätt! Kombinationen av kryddig köttfärs och '
                                                        'krämig potatis var en dundersuccé hos både stora och små.',
                                             'date': 'Idag',
                                             'name': 'Marie Lindberg',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Kanonrecept! Tog Prästost på toppen vilket gav fin sälta och '
                                                        'grym färg.',
                                             'date': 'Igår',
                                             'name': 'Henrik S.',
                                             'rating': 5,
        ...
        'faqs': [       {       'a': 'Ja, absolut! Bygg ihop gratängen i formen på förmiddagen, plasta in och ställ i '
                                     'kylen. Grädda den sedan direkt före servering (lägg till 5 minuter på '
                                     'gräddningstiden om den är kylskåpskall).',
                                'q': 'Kan man förbereda gratängen i förväg?'},
                        {       'a': 'Ja, byt grädde och mjölk mot havregrädde och använd en smakrik växtbaserad ost '
                                     'som smälter bra.',
        ...
        'ingredients': [       {       'group': 'Köttfärsfyllning',
                                       'items': [       {'name': 'nötfärs eller blandfärs', 'unit': 'g', 'val': 500},
                                                        ...
                                                        {       'name': 'krossade tomater av god kvalitet',
                                                                'unit': 'g',
                                                                'val': 400},
                                                        {'name': 'oxfond eller kalvfond', 'unit': 'msk', 'val': 1.5},
                                                        {       'name': 'torkad oregano eller timjan',
                                                                'unit': 'tsk',
                                                                'val': 1},
                               ...
                               {       'group': 'Potatis & Gräddblandning',
                                       'items': [       {       'name': 'fast potatis (skalad och tunt skivad)',
                                                                'unit': 'g',
                                                                'val': 800},
                                                        {       'name': 'vispgrädde eller matlagningsgrädde',
                                                                'unit': 'dl',
                                                                'val': 3},
                                                        ...
                                                        {       'name': 'riven lagrad ost (t.ex. Prästost eller Grevé)',
                                                                ...
                                                                'val': 2}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 200°C. Hetta upp smör i en stekpanna och fräs lök och '
                                                'vitlök mjuk. Tillsätt färsen och bryn tills den är genomstekt. Rör i '
                                                'tomatpuré, krossade tomater, fond, oregano, soja, salt och peppar. '
                                                'Låt sjuda i 10 minuter.',
                                        'timer': 10,
                                        'title': 'Bryn färsen och koka såsen'},
                                {       'step': 2,
                                        'text': 'Skala potatisen och skiva den i tunna skivor (cirka 2–3 mm), gärna '
                                                'med en mandolin så skivorna blir jämna och tillagas snabbt.',
                                        'timer': None,
                                        'title': 'Skiva potatisen'},
                                {       'step': 3,
                                        'text': 'Smörj en ugnsform. Lägg hälften av potatisskivorna i botten. Bred '
                                                'över hela köttfärssåsen jämnt. Toppa med resten av potatisskivorna i '
                                                'ett snyggt omlottmönster.',
                                        'timer': None,
                                        'title': 'Varva i formen'},
                                {       'step': 4,
                                        'text': 'Blanda grädde, mjölk och lite salt i en skål och häll jämnt över '
                                                'gratängen. Strö över rikligt med riven lagrad ost.',
                                        'timer': None,
                                        'title': 'Häll på grädden och osten'},
                                {       'step': 5,
                                        'text': 'Grädda mitt i ugnen i cirka 35–40 minuter tills potatisen är helt '
                                                'mjuk när du känner med en provsticka och osten är bubblande och '
                                                'gyllenbrun. Låt vila 5 minuter före servering.',
                                        'timer': 38,
    ...
    {       'alt': 'Klassisk svensk prinsesstårta med grönt marsipanlock, pudrat florsocker och rosa marsipanros',
        ...
        'cat_slug': 'fika-och-bakning',
        'category': 'Fika & Bakning',
        'community_reviews': [       {       'comment': 'Bästa prinsesstårtan jag någonsin bakat! Botten blev så '
                                                        'luftig och hemgjorda vaniljkrämen gjorde hela skillnaden.',
                                             'date': 'Idag',
                                             'name': 'Elisabeth V.',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Gjorde succé på födelsedagskalaset. Instruktionerna för '
                                                        'kupolen var guld värda.',
                                             'date': 'I förrgår',
        ...
        'faqs': [       {       'a': 'Grädde innehåller fukt som löser upp sockret i marsipanen. Stryk antingen ett '
                                     'mycket tunt lager smörkräm över grädden, eller lägg på marsipanlocket bara några '
                                     'timmar innan servering.',
                                'q': "Hur undviker man att marsipanen 'svettas' på tårtan?"},
                        {       'a': 'Potatismjöl saknar gluten vilket gör att tårtbotten blir exceptionellt lätt, '
                                     'porös och fluffig, precis som på ett klassiskt konditori.',
        ...
        'ingredients': [       {       'group': 'Tårtbotten (3 delar)',
                                       'items': [       {'name': 'ekologiska ägg', 'unit': 'st', 'val': 4},
                                                        ...
                                                        {       'name': 'potatismjöl (ger extra luftighet)',
                                                                'unit': 'dl',
                                                                'val': 1},
                                                        {'name': 'bakpulver', 'unit': 'tsk', 'val': 1.5},
                                                        {'name': 'vaniljsocker', 'unit': 'tsk', 'val': 1}]},
                               {       'group': 'Fyllning',
                                       'items': [       {       'name': 'hallonsylt av god kvalitet',
                                                                'unit': 'dl',
                                                                'val': 1.5},
                                                        {       'name': 'äkta vaniljkräm (kokt på mjölk, äggulor och '
                                                                        'vaniljstång)',
                                                                'unit': 'dl',
                                                                'val': 2.5},
                                                        {'name': 'vispgrädde (vispad fast)', 'unit': 'dl', 'val': 5}]},
                               {       'group': 'Garnering',
                                       'items': [       {       'name': 'färdigkavlat grönt marsipanlock (eller 400g '
                                                                        'grön marsipan)',
                                                                'unit': 'st',
                                                                'val': 1},
                                                        {       'name': 'rosa marsipanros med gröna blad',
                                                                'unit': 'st',
                                                                'val': 1},
                                                        {'name': 'florsocker', 'unit': 'msk', 'val': 1}]}],
        'instructions': [       {       'step': 1,
                                        'text': 'Sätt ugnen på 175°C. Vispa ägg och socker riktigt vitt och pösigt i '
                                                'minst 5–7 minuter. Sikta ner vetemjöl, potatismjöl, bakpulver och '
                                                'vaniljsocker och vänd försiktigt ihop med slickepott. Häll i smord '
                                                'och bröad form (22–24 cm) och grädda i ca 25 minuter. Låt svalna helt '
                                                'och dela i tre bottnar.',
                                        'timer': 25,
                                        'title': 'Grädda tårtbotten'},
                                {       'step': 2,
                                        'text': 'Lägg den första botten på ett tårtfat. Bred ut hallonsylten jämnt. '
                                                'Lägg på lite vaniljkräm och täck med den andra tårtbotten.',
                                        'timer': None,
                                        'title': 'Första lagret: hallonsylt & vaniljkräm'},
                                {       'step': 3,
                                        'text': 'Bred ut resten av vaniljkrämen över den andra botten. Lägg på den '
                                                'tredje tårtbotten. Klicka ut den vispade grädden på toppen och forma '
                                                'till en hög, jämn och rund kupol med hjälp av en palettkniv. Stryk '
                                                'ett tunt lager grädde runt kanterna.',
                                        'timer': None,
                                        'title': 'Andra lagret & gräddkupol'},
                                {       'step': 4,
                                        'text': 'Rulla försiktigt ut marsipanlocket över kupolen. Jämna till locket '
                                                'med händerna från toppen och nedåt runt kanterna utan att det veckar '
                                                'sig. Skär bort överflödig marsipan längst ner vid tårtans kant.',
                                        'timer': None,
                                        'title': 'Klä med marsipanlock'},
                                {       'step': 5,
                                        'text': 'Pudra tårtan lätt med florsocker genom en sil. Placera den rosa '
                                                'marsipanrosen mitt på tårtan. Låt gärna vila i kylen 1–2 timmar före '
                                                'servering.',
                                        'timer': 60,
                                        'title': 'Garnera'}],
    ...
    {       'alt': 'Klassisk svensk tunnbrödsrulle med korv, potatismos, räksallad och rostad lök i smörpapper',
        ...
        'cat_slug': 'husmanskost',
        'category': 'Husmanskost',
        'community_reviews': [       {       'comment': 'Underbar nostalgi! Hemlagat mos med lite muskot och en '
                                                        'krispig grillkorv slår alla gatukök.',
                                             'date': 'Idag',
                                             'name': 'Björn Ström',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Perfekt helglunch efter utedagen. Rostade löken och '
                                                        'räksalladen sätter verkligen pricken över i:et.',
                                             'date': 'Igår',
                                             'name': 'Jenny Lindvall',
                                             'rating': 5,
                                             'verified': True}],
        ...
        'faqs': [       {       'a': "Ja, en klassisk gatuköksbeställning är 'en dubbel' – lägg bara två korvar "
                                     'istället för en i moset för en riktigt mättande måltid!',
                                'q': 'Kan man göra dubbelrulle?'},
                        {       'a': 'Välj en räksallad med hög räkhalt (minst 25-30%) och rikligt med dill och citron '
        ...
        'ingredients': [       {       'group': 'Tunnbrödsrulle',
                                       'items': [       {'name': 'mjuka tunnbrödskakor', 'unit': 'st', 'val': 4},
                                                        {       'name': 'grillkorvar eller wienerkorvar av god '
                                                                        'kvalitet',
                                                                'unit': 'st',
                                                                'val': 4},
                                                        {       'name': 'god räksallad (gärna hemgjord med handskalade '
                                                                        'räkor)',
                                                                'unit': 'g',
                                                                'val': 200},
                               ...
                               {       'group': 'Hemlagat Potatismos',
                                       'items': [       {       'name': 'mjölig potatis (t.ex. King Edward)',
                                                                'unit': 'g',
                                                                'val': 800},
        ...
        'instructions': [       {       'step': 1,
                                        'text': 'Skala potatisen och koka mjuk i saltat vatten i ca 15–20 minuter. '
                                                'Häll av vattnet noga. Mosa potatisen med smör, varm mjölk, muskotnöt, '
                                                'salt och vitpeppar till ett fylligt, fluffigt mos.',
                                        'timer': 20,
                                        'title': 'Koka och mosa potatisen'},
                                {       'step': 2,
                                        'text': 'Stek eller grilla korvarna i en panna med lite smör tills de har fått '
                                                'fin gyllene färg och knaprig yta.',
                                        'timer': 8,
                                        'title': 'Stek eller grilla korven'},
                                {       'step': 3,
                                        'text': 'Lägg ut tunnbröden på varsitt ark smörpapper. Klicka ut en rejäl '
                                                'sträng varmt potatismos längs mitten av varje bröd.',
                                        'timer': None,
                                        'title': 'Montera rullen'},
                                {       'step': 4,
                                        'text': 'Lägg en nystekt korv ovanpå moset. Ringla över sötstark senap och '
                                                'ketchup. Klicka på en generös mängd räksallad.',
                                        'timer': None,
                                        'title': 'Lägg på korv och fyllning'},
                                {       'step': 5,
                                        'text': 'Strö över krispig rostad lök och färskhackad gräslök. Rulla ihop '
                                                'tunnbrödet tätt från ena sidan och snurra in nedre halvan i '
                                                'smörpapperet så den håller ihop. Ät direkt!',
                                        'timer': None,
    ...
    {       'alt': 'Smörstekta knapriga isterband med dillstuvad potatis, inlagda rödbetor och grovkornig senap',
        ...
        'cat_slug': 'husmanskost',
        'category': 'Husmanskost',
        'community_reviews': [       {       'comment': 'Riktig småländsk husmanskost! Den dillstuvade potatisen var '
                                                        'perfekt krämig och isterbanden blev knapriga.',
                                             'date': 'Idag',
                                             'name': 'Gunnar Johansson',
                                             'rating': 5,
                                             'verified': True},
                                     {       'comment': 'Underbart gott! En klassiker som aldrig går ur tiden. '
                                                        'Rödbetorna och senapen fulländar rätten.',
                                             'date': 'Igår',
                                             'name': 'Astrid Ek',
                                             'rating': 5,
                                             'verified': True}],
        ...
        'faqs': [       {       'a': 'Den unika syrligheten kommer från en naturlig mjölksyrajäsning som traditionellt '
                        ...
                        {       'a': 'Ja, dela isterbanden på längden och stek dem i ugnen på 200°C i ca 15–20 minuter '
                                     'med snittytan uppåt tills de fått fin färg.',
                                'q': 'Kan man steka isterband i ugnen?'}],
        'file': 'klassiska-isterband-dillstuvad-potatis-rodbetor.html',
        'img': 'isterband',
        'ingredients': [       {       'group': 'Isterband',
                                       'items': [       {       'name': 'småländska isterband (av god kvalitet)',
                                                                'unit': 'st',
                                                                'val': 4},
                                                        {'name': 'smör till stekning', 'unit': 'msk', 'val': 2}]},
                               {       'group': 'Dillstuvad Potatis',
                                       'items': [       {       'name': 'kokt fast potatis (kall, tärnad i ca 2 cm '
                                                                        'bitar)',
                                                                'unit': 'g',
                                                                'val': 800},
                                                        {'name': 'smör', 'unit': 'msk', 'val': 2},
                                                        {'name': 'vetemjöl', 'unit': 'msk', 'val': 2},
                                                        {       'name': 'standardmjölk (eller hälften grädde)',
                                                                'unit': 'dl',
                                                                'val': 4},
                                                        {       'name': 'färsk dill (rikligt finhackad)',
                                                                'unit': 'kruka',
                                                                'val': 1},
                                                        {'name': 'riven muskotnöt', 'unit': 'krm', 'val': 1},
                                                        {'name': 'salt och vitpeppar', 'unit': 'tsk', 'val': 0.5}]},
        ...
        'instructions': [       {       'step': 1,
                                ...
                                {       'step': 2,
                                        'text': 'Smält 2 msk smör i en kastrull på medelvärme. Vispa ner vetemjölet '
                                                'och låt fräsa ihop i 1 minut utan att ta färg. Späd med mjölken lite '
                                                'i taget under konstant vispning så det inte klumpar sig. Låt sjuda '
                                                'sakta i 5 minuter.',
                                        'timer': 5,
                                        'title': 'Gör stuvningen'},
                                {       'step': 3,
                                        'text': 'Smaka av stuvningen med salt, vitpeppar och en nypa riven muskot. '
                                                'Vänd försiktigt ner potatistärningarna och rikligt med finhackad '
                                                'dill. Låt potatisen bli genomvarm på svag värme utan att brännas vid.',
                                        'timer': 5,
                                        'title': 'Vänd ner potatis och dill'},
                                {       'step': 4,
                                        'text': 'Snitta isterbanden lätt på längden så skinnet inte spricker '
                                                'okontrollerat. Hetta upp smör i en gjutjärnspanna på medelvärme. Stek '
                                                'isterbanden runt om i ca 10–12 minuter tills de har fått mörk '
                                                'gyllenbrun färg och knaprigt skinn.',
                                        'timer': 12,
                                        'title': 'Stek isterbanden'},
                                {       'step': 5,
                                        'text': 'Lägg upp de nystekta isterbanden tillsammans med en rejäl sked '
                                                'rykande het dillstuvad potatis, inlagda rödbetor och en klick '
                                                'grovkornig senap.',
                                        'timer': None,
                                        'title': 'Servera'}],
